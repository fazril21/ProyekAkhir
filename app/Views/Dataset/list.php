    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body py-0">
                ...
                <form action="<? base_url('Apps/UploadFiles')?>" id="form-import-file" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div id="btn-upload" class="d-none">
                        <div class="flex-column border-top-0">
                            <button type="submit" id="submit" name="submit" class="btn btn-lg btn-primary w-100 mx-0 mb-2"><i class="fas fa-cloud-upload-alt"></i> Upload</button>
                        </div>
                    </div>
                </form>
                <div class="flex-column border-top-0">
